...
<link rel="stylesheet" href="{{ asset('dist/css/laporan.css') }}">
@endsection

@section('title', 'Lapor - Pengaduan Masyarakat')
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12 col">
            <div class="content content-bottom shadow">
                <div>
                    <img src="{{ asset('dist/images/user_default.svg') }}" alt="user profile" class="photo">
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8">
            <div class="laporan-top">
                <img src="{{ asset('dist/images/user_default.svg') }}" alt="profile" class="profile">
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2021 Samuel • All rights reserved</p>
    </div>
</div>
@endsection
